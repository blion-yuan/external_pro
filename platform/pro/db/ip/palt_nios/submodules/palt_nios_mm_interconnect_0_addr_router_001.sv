...
module palt_nios_mm_interconnect_0_addr_router_001_default_decode
  #(
...
module palt_nios_mm_interconnect_0_addr_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD4 = log2ceil(64'h9040 - 64'h9020); 
    localparam PAD5 = log2ceil(64'h9060 - 64'h9040); 
    ...
    palt_nios_mm_interconnect_0_addr_router_001_default_decode the_default_decode(
    ...
    // ( 0x9070 .. 0x9078 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 16'h9070  && read_transaction  ) begin
